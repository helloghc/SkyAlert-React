  ...
  return (
    ...
    >
      ...
      <div className="footer-container2">
        ...
        >
          <svg viewBox="0 0 950.8571428571428 1024" className="footer-icon02">
            <path
        ...
        >
          <svg viewBox="0 0 877.7142857142857 1024" className="footer-icon08">
            <path
      ...
      <span className="footer-text content-Light">
        <span className="">Términos y Condiciones de Uso</span>
        <br className=""></br>
...
Footer.defaultProps = {
  image_alt: 'image',
  image_alt21: 'image',
  image_src21: '/playground_assets/skyalert-%5B2%5D_44-300h.png',
  image_alt1: 'image',
  rootClassName: '',
  image_src1: '/playground_assets/skyalert-%5B2%5D_40-300h.jpg',
  image_src2: '/playground_assets/skyalert-%5B2%5D_42-300h.jpg',
  image_alt2: 'image',
  image_src: '/playground_assets/logo1-400h.png',
}
