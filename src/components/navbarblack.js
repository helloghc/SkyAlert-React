      ...
      <header data-role="Header" className="navigation-container">
        ...
        <div data-type="MobileMenu" className="navigation-mobile-menu">
          ...
          <div className="navbarblack-social-media">
            <span className="navbarblack-text">{props.text}</span>
            <div className="navbarblack-container1">
              <svg viewBox="0 0 1024 1024" className="navbarblack-icon04">
                <path
              ...
              <svg viewBox="0 0 1024 1024" className="navbarblack-icon08">
                <path
