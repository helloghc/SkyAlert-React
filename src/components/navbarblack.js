...
import NavigationLinksblack from './navigation-linksblack'
import './navbarblack.css'

const Navbarblack = (props) => {
  return (
    <div className={`navbarblack-navbar-container ${props.rootClassName} `}>
      <header data-role="Header" className="navigation-container">
        <img
          src="/playground_assets/logo1-1500h.png"
          className="navbarblack-image"
        />
        <div className="navbarblack-nav">
          <NavigationLinksblack
            rootClassName="navigation-linksblack-root-class-name"
            className=""
          ></NavigationLinksblack>
        </div>
        <div
          data-type="MobileMenu"
          className="navigation-mobile-menu navbarblack-mobile-menu"
        >
          <div className="navbarblack-nav1">
            <div className="navbarblack-container">
              <img
                alt={props.image_alt1}
                src="/playground_assets/logo1-1500h.png"
                className="navbarblack-image1"
              />
              <div
                data-type="CloseMobileMenu"
                className="navbarblack-menu-close"
              >
                <svg viewBox="0 0 1024 1024" className="navbarblack-icon">
                  <path
            ...
            <nav className="navbarblack-nav2">
              ...
              <Link to="/blog" className="navbarblack-navlink4 navbar-link">
                {props.text411}
              </Link>
            </nav>
          ...
          <div className="navbarblack-social-media">
            <span className="navbarblack-text1">{props.text}</span>
            <div className="navbarblack-container1">
              <svg viewBox="0 0 1024 1024" className="navbarblack-icon02">
                <path
              ...
              <svg viewBox="0 0 1024 1024" className="navbarblack-icon06">
                <path
              ...
              <svg viewBox="0 0 1024 1024" className="navbarblack-icon10">
                <path
              ...
              <svg viewBox="0 0 1024 1024" className="navbarblack-icon12">
                <path
        ...
        <div data-type="BurgerMenu" className="navigation-burger-menu">
          <svg viewBox="0 0 1024 1024" className="navbarblack-icon14">
            <path
...
Navbarblack.defaultProps = {
  ...
  image_src1: '409bb369-f4c0-4878-9c6f-e088ed8524ba',
  rootClassName: '',
  text: 'Follow us',
  text3: 'REDSkyAlert',
