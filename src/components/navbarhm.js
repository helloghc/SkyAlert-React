...
const Navbarhm = (props) => {
  return (
    <div className={`navbarhm-navbar-container ${props.rootClassName} `}>
      <header data-role="Header" className="navigation-container">
        <Link to="/">
          <img
            alt={props.image_alt}
            src={props.image_src3}
            className="navbarhm-image"
          />
        </Link>
        <svg viewBox="0 0 1024 1024" className="navbarhm-icon">
          <path d="M128 256h768v86h-768v-86zM128 554v-84h768v84h-768zM128 768v-86h768v86h-768z"></path>
        </svg>
        <div className="navbarhm-nav"></div>
        <div data-type="BurgerMenu" className="navigation-burger-menu">
          <svg viewBox="0 0 1024 1024" className="navbarhm-icon02">
            <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
          </svg>
        </div>
        <div
          data-type="MobileMenu"
          className="navigation-mobile-menu navbarhm-mobile-menu"
        >
          <div className="navbarhm-nav1">
            <div className="navbarhm-container">
              <img
                alt={props.image_alt1}
                src={props.image_src1}
                className="navbarhm-image1"
              />
              <div data-type="CloseMobileMenu" className="navbarhm-menu-close">
                <svg viewBox="0 0 1024 1024" className="navbarhm-icon04">
                  <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                </svg>
              </div>
            </div>
            <nav className="navbarhm-nav2">
              <Link to="/" className="navbarhm-text navbar-link">
                {props.text1}
              </Link>
              <Link
                to="/suite-de-soluciones"
                className="navbarhm-navlink1 navbar-link"
              >
                {props.text11}
              </Link>
              <Link to="/app" className="navbarhm-navlink2 navbar-link">
                {props.text2}
              </Link>
              <Link
                to="/red-skyalert"
                className="navbarhm-navlink3 navbar-link"
              >
                {props.text3}
              </Link>
              <Link
                to="/por-que-skyalert"
                className="navbarhm-navlink4 navbar-link"
              >
                {props.text4}
              </Link>
              <Link to="/prensa" className="navbarhm-navlink5 navbar-link">
                {props.text41}
              </Link>
              <Link to="/blog" className="navbarhm-navlink6 navbar-link">
                {props.text411}
              </Link>
            </nav>
            <button className="navbarhm-primary-btn button-primary button">
              {props.PrimaryBtn1}
            </button>
          </div>
          <div className="navbarhm-social-media">
            <span className="navbarhm-text1">{props.text}</span>
            <div className="navbarhm-container1">
              <svg viewBox="0 0 1024 1024" className="navbarhm-icon06">
              ...
              <svg viewBox="0 0 1024 1024" className="navbarhm-icon10">
              ...
              <svg viewBox="0 0 1024 1024" className="navbarhm-icon14">
              ...
              <svg viewBox="0 0 1024 1024" className="navbarhm-icon16">
...
Navbarhm.defaultProps = {
  text1: 'Home',
  text: 'Follow us',
  image_alt: 'image',
  image_alt1: 'image',
  image_src3: '/playground_assets/logo1-1500h.png',
  text2: 'App',
