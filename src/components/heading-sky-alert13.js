...
import './heading-sky-alert13.css'

const HeadingSkyAlert13 = (props) => {
  return (
    <div className={`heading sky-alert 1.3-container ${props.rootClassName} `}>
      <img
        alt={props.image_alt}
        src={props.image_src}
        className="heading sky-alert 1.3-image"
      />
      <h1 className="heading sky-alert 1.3-text">{props.heading}</h1>
      <div className="heading sky-alert 1.3-container1">
        <div className="heading sky-alert 1.3-container2">
          <span className="">{props.text}</span>
          <span className="heading sky-alert 1.3-text2">{props.text1}</span>
        </div>
        <span className="">{props.text2}</span>
      </div>
      <div className="heading sky-alert 1.3-container3">
        <div className="heading sky-alert 1.3-card">
          <img
            alt={props.image_alt11}
            src={props.image_src11}
            className="heading sky-alert 1.3-image1"
          />
          <h4 className="heading sky-alert 1.3-text4 heading4">
            {props.heading11}
          </h4>
          <span className="heading sky-alert 1.3-text5 content-Light">
            {props.text31}
          </span>
        </div>
        <div className="heading sky-alert 1.3-card1">
          <img
            alt={props.image_alt1}
            src={props.image_src1}
            className="heading sky-alert 1.3-image2"
          />
          <h4 className="heading sky-alert 1.3-text6 heading4">
            {props.heading111}
          </h4>
          <span className="heading sky-alert 1.3-text7 content-Light">
            {props.text311}
          </span>
        </div>
      </div>
