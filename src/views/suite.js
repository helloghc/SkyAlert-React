...
const Suite = (props) => {
  return (
    <div className="suite-container">
      ...
      <div className="suite-container60">
        <div className="suite-container61">
            ...
            <ul className="list">
              <li className="list-item">
                <span>
                  <span>1 dispositivo receptor</span>
                  <br></br>
                  <span>1 bocina de 15W</span>
                  <br></br>
                  <span>1 amplificador de 20W</span>
                  <br></br>
                  <span>1 base para amplificador</span>
                  <br></br>
          ...
          <div className="suite-card31">
            ...
            <h1 className="suite-text147">$3,588*</h1>
            <span>*Términos y condiciones</span>
          </div>
        </div>
      </div>
      ...
      <div className="suite-container85">
        <div className="suite-container86">
          <img
            alt="image"
            src="/playground_assets/skyalert-%5B2%5D_04-300h.png"
            className="suite-image64"
          />
          <div className="suite-container87">
            <h2 className="suite-text182 heading2">
              <span>Hablemos de soluciones empresariales</span>
